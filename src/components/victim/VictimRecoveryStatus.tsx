    ...
    <div className="space-y-6 animate-in fade-in duration-300">
        ...
        {complaints.length > 1 && (
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2 text-xs font-semibold rounded-xl border border-slate-300 bg-white text-slate-900"
            >
              {complaints.map((c) => (
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-6">
        ...
        <div>
          ...
          {/* Legend */}
          <div className="flex flex-wrap items-center gap-4 text-xs font-medium mt-3 pt-2 border-t border-slate-100">
        ...
        <div className="space-y-4 text-xs">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
              ...
              <p className="text-slate-600 leading-relaxed">
                Investigating officer issued statutory lien requisition. The amount of <strong className="text-indigo-600">{formatINR(recovery.amountFrozen)}</strong> has been segregated and locked against withdrawal in the recipient branch.
              </p>
            </div>
          </div>
          ...
          {/* Step 3 */}
          <div className="flex items-start gap-3">
            <div className="w-7 h-7 rounded-full bg-amber-100 text-amber-700 flex items-center justify-center shrink-0 font-bold">
              3
            </div>
            <div className="flex-1 p-3.5 rounded-xl bg-amber-50/50 border border-amber-200">
              <div className="flex items-center justify-between mb-1">
                <span className="font-bold text-slate-900">
      ...
      <div className="bg-slate-100 rounded-2xl border border-slate-200 p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs">
