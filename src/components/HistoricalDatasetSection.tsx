        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="px-3 py-2 rounded-lg border border-slate-300 text-xs font-semibold text-slate-700 hover:bg-slate-100 flex items-center gap-1.5 transition-colors"
            >
            ...
            {/* CSV / JSON Upload */}
            <label className="px-3.5 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-semibold flex items-center gap-1.5 cursor-pointer transition-colors">
        ...
        <div className="mt-5 pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600"
            />
          </div>

          <div className="text-xs text-slate-500">
            Total Cases in Repository:{' '}
            <span className="font-bold text-slate-900">{historicalCases.length} records</span>
          </div>
        </div>
      </div>
            ...
            <tbody className="divide-y divide-slate-100">
              {filteredCases.length === 0 ? (
                ...
                filteredCases.map((hc) => (
                  <tr key={hc.caseId} className="hover:bg-slate-50 transition-colors">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 bg-white border border-slate-300 rounded-lg text-slate-900 font-semibold text-blue-600"
                  />
                </div>
              </div>
