    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-md w-full p-6 shadow-2xl relative">
        ...
        <div className="text-center mb-6">
          ...
          <div className="text-[11px] font-bold uppercase tracking-widest text-blue-700 dark:text-blue-400">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-blue-600"
                  />
                </div>
              </div>
          ...
          <div className="mt-5 pt-4 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="p-2 rounded-lg bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 text-left hover:border-blue-500 transition-colors"
              >
                <div className="text-[11px] font-bold text-slate-900 dark:text-white">Investigating Officer</div>
              ...
              <button
                ...
                className="p-2 rounded-lg bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 text-left hover:border-blue-500 transition-colors"
              >
                <div className="text-[11px] font-bold text-slate-900 dark:text-white">Administrator</div>
