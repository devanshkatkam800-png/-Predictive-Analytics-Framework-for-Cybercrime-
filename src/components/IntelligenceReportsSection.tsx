      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-xs text-right">
        ...
        {filteredReports.length === 0 ? (
          ...
          filteredReports.map((report) => {
            ...
            return (
              <div
                key={report.reportId}
                className="bg-white border border-slate-200 rounded-2xl p-5 shadow-xs hover:border-blue-500/50 transition-all flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100 text-xs mb-3 space-y-1">
                    <div className="flex items-center justify-between text-[11px]">
                      ...
                      <span className="font-mono font-bold text-slate-800">{report.complaintId}</span>
                    </div>
                    <div className="flex items-center justify-between text-[11px]">
